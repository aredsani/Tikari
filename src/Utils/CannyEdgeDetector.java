...
/**
 * If you make changes here make sure the tests and examples still work :D
 *
 ...
 * <pre><code>
 * //create the detector
 * RandomOld.CannyEdge detector = new RandomOld.CannyEdge();
    ...
    private void computeGradients(float kernelRadius, int kernelWidth) {
        ...
        for (int x = initX; x < maxX; x++) {
            for (int y = initY; y < maxY; y += width) {
				 ...
				 * gradient direction, we use two simple comparisons: RandomOld.first we
